...
function getNutrientVal(nutrients, ids, nameKeywords) {
  const nut = nutrients.find(n =>
    ...
    nameKeywords.some(kw => n.nutrientName && n.nutrientName.toLowerCase().includes(kw.toLowerCase()))
  );
    ...
    breakfast: [
      {
        ...
        description: "Organic rolled oats soaked in almond milk, loaded with chia seeds, flax seeds, and raw organic hemp seeds. Topped with fresh blueberries and a splash of maple syrup.",
        image: "https://images.unsplash.com/photo-1517881917430-e70dfb3610aa?q=80&w=600&auto=format&fit=crop",
        pairing: { name: "Macadamia Milk Matcha", description: "Matcha green tea whisked with creamy unsweetened macadamia nut milk.", icon: "local_drink" },
        baseCalories: 450,
        baseProtein: 15,
        baseFat: 14,
        baseCarbs: 65,
    ...
    lunch: [
      {
        ...
        description: "Marinated pan-seared organic tempeh, served over a colorful bed of red quinoa, steamed broccoli florets, shredded purple cabbage, avocado slices, and drizzled with a rich tahini ginger dressing.",
        image: "https://images.unsplash.com/photo-1512621776951-a57141f2eefd?q=80&w=600&auto=format&fit=crop",
        pairing: { name: "Probiotic Kombucha", description: "Chilled organic ginger-lemon kombucha for digestive health.", icon: "local_drink" },
        baseCalories: 650,
        baseProtein: 28,
        baseFat: 25,
        baseCarbs: 78,
    ...
    dinner: [
      {
        ...
        description: "Slow-simmered brown lentils and chickpeas in a coconut milk, tomato, and aromatic spice curry base. Served with cauliflower rice and fresh coriander.",
        image: "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?q=80&w=600&auto=format&fit=crop",
        pairing: { name: "Warm Ginger Tea", description: "Freshly brewed ginger and lemon root infusion.", icon: "coffee" },
        baseCalories: 550,
        baseProtein: 22,
        baseFat: 18,
        baseCarbs: 75,
    ...
    snack: [
      {
        ...
        description: "Steamed edamame pods sprinkled with sea salt and paired with dry roasted pumpkin seeds.",
        image: "https://images.unsplash.com/photo-1615485290382-441e4d049cb5?q=80&w=600&auto=format&fit=crop",
        pairing: { name: "Mineral Water", description: "Sparkling spring water with lime.", icon: "local_drink" },
        baseCalories: 250,
        baseProtein: 18,
        baseFat: 12,
        baseCarbs: 18,
    ...
    breakfast: [
      {
        ...
        description: "Crispy high-fiber finger millet dosa served with a side of scrambled paneer sautéed with tomatoes, green chillies, and fresh coriander.",
        image: "https://images.unsplash.com/photo-1668236543090-82eba5ee5976?q=80&w=600&auto=format&fit=crop",
        pairing: { name: "Protein Coffee", description: "Double shot espresso blended with vanilla whey protein isolate and ice.", icon: "coffee" },
        baseCalories: 500,
        baseProtein: 30,
        baseFat: 18,
        baseCarbs: 55,
    ...
    lunch: [
      {
        ...
        description: "Clay-oven roasted cottage cheese skewers marinated in Greek yogurt spices, served on a bed of sprouted mung beans and mixed greens salad.",
        image: "https://images.unsplash.com/photo-1565557623262-b51c2513a641?q=80&w=600&auto=format&fit=crop",
        pairing: { name: "Spiced Buttermilk", description: "Chilled low-fat buttermilk seasoned with ginger, cumin, and mint.", icon: "local_drink" },
        baseCalories: 650,
        baseProtein: 35,
        baseFat: 26,
        baseCarbs: 68,
    ...
    dinner: [
      {
        ...
        description: "Firm organic tofu cubes stir-fried with bell peppers, mushrooms, and asparagus in a tamari sesame glaze over fluffy white quinoa.",
        image: "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?q=80&w=600&auto=format&fit=crop",
        pairing: { name: "Green Tea", description: "Pure organic sencha green tea.", icon: "coffee" },
        baseCalories: 550,
        baseProtein: 25,
        baseFat: 16,
        baseCarbs: 76,
    ...
    snack: [
      {
        ...
        description: "High-density plant protein soya chunks dry-roasted with chaat masala and olive oil spray.",
        image: "https://images.unsplash.com/photo-1615485290382-441e4d049cb5?q=80&w=600&auto=format&fit=crop",
        pairing: { name: "Hydration Electrolytes", description: "Water with dynamic trace mineral electrolytes.", icon: "local_drink" },
        baseCalories: 200,
        baseProtein: 22,
        baseFat: 4,
        baseCarbs: 18,
    ...
    breakfast: [
      {
        ...
        description: "Omelet made from 5 organic egg whites and 1 whole egg, loaded with baby spinach and mushrooms, served with high-protein oats toast.",
        image: "https://images.unsplash.com/photo-1525351484163-7529414344d8?q=80&w=600&auto=format&fit=crop",
        pairing: { name: "Black Coffee", description: "Double shot of fresh espresso with no sugars.", icon: "coffee" },
        baseCalories: 450,
        baseProtein: 38,
        baseFat: 10,
        baseCarbs: 52,
    ...
    lunch: [
      {
        ...
        description: "Herb-marinated grilled chicken breast slices, served over organic white quinoa, steamed broccoli, roasted sweet potatoes, and a side of light olive oil vinaigrette.",
        image: "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?q=80&w=600&auto=format&fit=crop",
        pairing: { name: "Iced Lime Water", description: "Freshly squeezed lime in sparkling water with mint.", icon: "local_drink" },
        baseCalories: 700,
        baseProtein: 55,
        baseFat: 18,
        baseCarbs: 78,
    ...
    dinner: [
      {
        ...
        description: "Lean baked turkey breast cutlets served with garlic stir-fried green beans, zucchini, and carrots, alongside wild rice.",
        image: "https://images.unsplash.com/photo-1544025162-d76694265947?q=80&w=600&auto=format&fit=crop",
        pairing: { name: "Chamomile Tea", description: "Warm chamomile herbal tea to promote restful recovery.", icon: "coffee" },
        baseCalories: 550,
        baseProtein: 45,
        baseFat: 12,
        baseCarbs: 65,
    ...
    snack: [
      {
        ...
        description: "Two farm-fresh boiled eggs paired with a handful of raw activated almonds.",
        image: "https://images.unsplash.com/photo-1587486913049-53fc88980cfc?q=80&w=600&auto=format&fit=crop",
        pairing: { name: "Filtered Water", description: "Purified water infused with cucumber slices.", icon: "local_drink" },
        baseCalories: 280,
        baseProtein: 18,
        baseFat: 20,
        baseCarbs: 6,
    ...
    breakfast: [
      {
        ...
        description: "Premium cold-smoked salmon slices laid over mashed ripe avocado on gluten-free multi-seed toast, topped with red onion slices and capers.",
        image: "https://images.unsplash.com/photo-1541518763669-27fef04b14ea?q=80&w=600&auto=format&fit=crop",
        pairing: { name: "Organic Green Tea", description: "Unsweetened hot green tea.", icon: "coffee" },
        baseCalories: 480,
        baseProtein: 28,
        baseFat: 22,
        baseCarbs: 42,
    ...
    lunch: [
      {
        ...
        description: "Fillet of Atlantic salmon grilled to perfection, flaked over a mixed greens salad with cooked quinoa, cherry tomatoes, cucumbers, and lemon-herb dressing.",
        image: "https://images.unsplash.com/photo-1467003909585-2f8a72700288?q=80&w=600&auto=format&fit=crop",
        pairing: { name: "Lemon Soda", description: "Chilled sparkling water with organic lemon juice.", icon: "local_drink" },
        baseCalories: 680,
        baseProtein: 46,
        baseFat: 28,
        baseCarbs: 60,
    ...
    dinner: [
      {
        ...
        description: "Lemon-pepper baked wild cod fillet, served over a bed of whole-wheat couscous and garlic-sautéed spinach.",
        image: "https://images.unsplash.com/photo-1519708227418-c8fd9a32b7a2?q=80&w=600&auto=format&fit=crop",
        pairing: { name: "Peppermint Infusion", description: "Soothing hot peppermint tea.", icon: "coffee" },
        baseCalories: 500,
        baseProtein: 38,
        baseFat: 10,
        baseCarbs: 62,
    ...
    snack: [
      {
        ...
        description: "Canned tuna in spring water, mixed with low-fat Greek yogurt, wrapped in crisp iceberg lettuce leaves.",
        image: "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?q=80&w=600&auto=format&fit=crop",
        pairing: { name: "Coconut Water", description: "Fresh natural coconut water for potassium replenishment.", icon: "local_drink" },
        baseCalories: 220,
        baseProtein: 26,
        baseFat: 4,
        baseCarbs: 10,
    ...
    breakfast: [
      {
        ...
        description: "Gluten-free rolled oats cooked in almond milk, topped with dynamic mixed berries, chia seeds, and walnut halves.",
        image: "https://images.unsplash.com/photo-1517881917430-e70dfb3610aa?q=80&w=600&auto=format&fit=crop",
        pairing: { name: "Espresso", description: "Double espresso shot brewed from organic Arabica beans.", icon: "coffee" },
        baseCalories: 440,
        baseProtein: 14,
        baseFat: 16,
        baseCarbs: 64,
    ...
    lunch: [
      {
        ...
        description: "Sautéed chicken strips, cooked quinoa, fresh diced avocado, and cucumber slices tossed in a light cold-pressed olive oil vinaigrette.",
        image: "https://images.unsplash.com/photo-1512621776951-a57141f2eefd?q=80&w=600&auto=format&fit=crop",
        pairing: { name: "Sparkling Mineral Water", description: "Naturally sparkling water from volcanic springs.", icon: "local_drink" },
        baseCalories: 650,
        baseProtein: 42,
        baseFat: 24,
        baseCarbs: 68,
    ...
    dinner: [
      {
        ...
        description: "Wild salmon fillet seared in coconut oil, served over a rich portion of garlic-roasted asparagus and sweet potato mash.",
        image: "https://images.unsplash.com/photo-1467003909585-2f8a72700288?q=80&w=600&auto=format&fit=crop",
        pairing: { name: "Herbal Infusion", description: "Hibiscus and rosehip tea.", icon: "coffee" },
        baseCalories: 600,
        baseProtein: 38,
        baseFat: 26,
        baseCarbs: 56,
    ...
    snack: [
      {
        ...
        description: "Crisp organic apple slices paired with two tablespoons of pure unrefined almond butter.",
        image: "https://images.unsplash.com/photo-1615485290382-441e4d049cb5?q=80&w=600&auto=format&fit=crop",
        pairing: { name: "Water", description: "Infused with fresh lemon juice.", icon: "local_drink" },
        baseCalories: 250,
        baseProtein: 6,
        baseFat: 18,
        baseCarbs: 22,
    ...
    breakfast: [
      {
        ...
        description: "Three farm-fresh organic eggs scrambled in grass-fed butter, mixed with chopped crispy bacon and topped with half a sliced avocado.",
        image: "https://images.unsplash.com/photo-1525351484163-7529414344d8?q=80&w=600&auto=format&fit=crop",
        pairing: { name: "Bulletproof Coffee", description: "Black coffee blended with MCT oil and unsalted grass-fed butter.", icon: "coffee" },
        baseCalories: 600,
        baseProtein: 30,
        baseFat: 52,
        baseCarbs: 6,
    ...
    lunch: [
      {
        ...
        description: "Diced grilled chicken breast, blue cheese crumbles, boiled egg, crispy bacon pieces, and cherry tomatoes on a bed of fresh romaine lettuce, dressed with extra virgin olive oil.",
        image: "https://images.unsplash.com/photo-1512621776951-a57141f2eefd?q=80&w=600&auto=format&fit=crop",
        pairing: { name: "Chilled Sparkling Water", description: "Carbonated water with a pinch of sea salt.", icon: "local_drink" },
        baseCalories: 750,
        baseProtein: 48,
        baseFat: 60,
        baseCarbs: 8,
    ...
    dinner: [
      {
        ...
        description: "USDA Prime ribeye steak pan-seared in grass-fed garlic butter, served with a side of sautéed asparagus.",
        image: "https://images.unsplash.com/photo-1544025162-d76694265947?q=80&w=600&auto=format&fit=crop",
        pairing: { name: "Warm Lemon Water", description: "Warm water with organic lemon juice.", icon: "coffee" },
        baseCalories: 700,
        baseProtein: 42,
        baseFat: 58,
        baseCarbs: 5,
    ...
    snack: [
      {
        ...
        description: "Dry roasted macadamia nuts served alongside aged cheddar cheese blocks.",
        image: "https://images.unsplash.com/photo-1615485290382-441e4d049cb5?q=80&w=600&auto=format&fit=crop",
        pairing: { name: "Water", description: "Infused with fresh mint.", icon: "local_drink" },
        baseCalories: 300,
        baseProtein: 8,
        baseFat: 30,
        baseCarbs: 4,
...
const INDIAN_INGREDIENTS_DB = {
  ...
  "toor dal": { calories: 343, proteinGrams: 22, carbsGrams: 58, fatGrams: 1.5 },
  "moong dal": { calories: 348, proteinGrams: 24, carbsGrams: 59, fatGrams: 1.2 },
  "masoor dal": { calories: 352, proteinGrams: 25, carbsGrams: 59, fatGrams: 1.0 },
  "ghee": { calories: 883, proteinGrams: 0, carbsGrams: 0, fatGrams: 99.8 },
  "mustard oil": { calories: 884, proteinGrams: 0, carbsGrams: 0, fatGrams: 100 },
  "roti": { calories: 120, proteinGrams: 3.5, carbsGrams: 24, fatGrams: 0.8 },
  "multigrain roti": { calories: 110, proteinGrams: 4, carbsGrams: 21, fatGrams: 1.0 },
  "wheat roti": { calories: 120, proteinGrams: 3.5, carbsGrams: 24, fatGrams: 0.8 },
  "chapati": { calories: 120, proteinGrams: 3.5, carbsGrams: 24, fatGrams: 0.8 },
  "brown rice": { calories: 111, proteinGrams: 2.6, carbsGrams: 23, fatGrams: 0.9 },
  "white rice": { calories: 130, proteinGrams: 2.7, carbsGrams: 28, fatGrams: 0.3 },
  "rice": { calories: 130, proteinGrams: 2.7, carbsGrams: 28, fatGrams: 0.3 },
  "chicken breast": { calories: 165, proteinGrams: 31, carbsGrams: 0, fatGrams: 3.6 },
  ...
  "egg white": { calories: 52, proteinGrams: 11, carbsGrams: 0.7, fatGrams: 0.2 },
  "tofu": { calories: 76, proteinGrams: 8, carbsGrams: 1.9, fatGrams: 4.8 },
  "greek yogurt": { calories: 59, proteinGrams: 10, carbsGrams: 3.6, fatGrams: 0.4 },
  ...
  "soya chunks": { calories: 345, proteinGrams: 52, carbsGrams: 33, fatGrams: 0.5 },
  "soy chunks": { calories: 345, proteinGrams: 52, carbsGrams: 33, fatGrams: 0.5 },
  ...
  "chia seeds": { calories: 486, proteinGrams: 16.5, carbsGrams: 42, fatGrams: 30.7 },
  ...
  "chickpea flour": { calories: 387, proteinGrams: 22, carbsGrams: 58, fatGrams: 7 },
...
function parseIngredientString(ingStr) {
  ...
  let normalizedStr = cleanStr.replace(/(\d+)\/(\d+)/g, (m, num, den) => parseFloat(num) / parseFloat(den));
...
function convertToGrams(amount, unit, name) {
  ...
  if (n.includes('roti') || n.includes('chapati') || n.includes('bread') || n.includes('paratha')) {
    return amount * 40;
  }
  if (n.includes('egg')) {
    return amount * 50;
...
function normalizeIngredientName(name) {
  ...
  cleaned = cleaned.replace(/\b(cooked|raw|grilled|boiled|fresh|organic|sliced|chopped|steamed|roasted|pan-seared|marinated|scrambled)\b/g, '');
...
async function fetchMealImage(mealName) {
  ...
  if (process.env.UNSPLASH_ACCESS_KEY) {
    try {
      ...
      console.error(`Unsplash image fetch failed for ${mealName}:`, err.message);
    }
  }
...
async function getIngredientNutrition(name) {
  ...
  const matchedKey = dbKeys.find(key => normName.includes(key) || key.includes(normName));
  if (matchedKey) {
    return INDIAN_INGREDIENTS_DB[matchedKey];
  }

  try {
    const cached = await MealNutritionCache.findOne({ ingredientName: normName });
    if (cached) {
      return {
    ...
    console.error(`MealNutritionCache lookup failed for ${normName}:`, err.message);
  }
  ...
  if (process.env.USDA_API_KEY) {
    try {
      ...
      if (usdaRes.data && usdaRes.data.foods && usdaRes.data.foods.length > 0) {
        ...
        const fatGrams = getNutrientVal(nutrients, [1004], ['total lipid', 'fat']);
        ...
        try {
          ...
          console.error(`Failed to save cache for ${normName}:`, saveErr.message);
        }

        return { calories, proteinGrams, carbsGrams, fatGrams };
      }
    } catch (usdaErr) {
      console.error(`USDA lookup failed for ingredient ${normName}:`, usdaErr.message);
    }
  }
...
router.post('/plan/generate', async (req, res) => {
  try {
    ...
    if (!targetCalories || !diet || !mealsPerDay) {
      return res.status(400).json({ error: 'Missing targetCalories, diet, or mealsPerDay in request' });
    }
...

{
  ...
  "meals": [
    ...
    const mealPromises = geminiPlan.meals.map(async (meal, i) => {
      ...
      const time = slot === 'breakfast' ? '08:00 AM'
        : slot === 'lunch' ? '01:30 PM'
          : slot === 'snack' ? '05:00 PM'
            : slot === 'dinner' ? '08:30 PM'
              : (times[i] || '12:00 PM');

      const tag = slot === 'breakfast' ? 'Pre-Load'
        : slot === 'lunch' ? 'Anabolic Window'
          : slot === 'snack' ? 'Mid-Day Fuel'
            : slot === 'dinner' ? 'Night Rest'
              : (tags[i] || 'Protocol');
      ...
      const ingredientPromises = ingredients.map(async (ingStr) => {
        ...
        try {
          ...
          console.error(`Error fetching nutrition for ingredient ${name}:`, ingErr.message);
      ...
      if (slot === 'breakfast') {
        pairing = { name: "Protein Coffee Pairing", description: "Whey-infused cold brew for immediate cognitive focus.", icon: "coffee" };
      } else if (slot === 'lunch') {
        pairing = { name: "Spiced Buttermilk", description: "Chilled probiotic blend with ginger to accelerate digestion.", icon: "local_drink" };
      } else if (slot === 'dinner') {
        pairing = { name: "Chamomile Tea", description: "Warm chamomile herbal tea to promote restful recovery.", icon: "coffee" };
      }
      ...
      return {
        ...
        time: time,
        tag: tag,
        description: meal.description || 'Premium meal tailored to performance macros.',
        image: imageUrl,
        nutrition: {
    ...
    console.error('Error generating meal plan:', error.response?.data || error.message || error);
    const errorDetails = error.response?.data?.error?.message || error.message || 'Server error';
    res.status(500).json({ error: `Server error generating meal plan: ${errorDetails}` });
  }
});
