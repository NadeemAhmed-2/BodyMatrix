const runFullTest = async () => {
  ...
  try {
    ...
    // We need the OTP. Since we are running node, we can read the latest logs to get the OTP!
    // But since that might be complex, let's look at the database directly!
    // Wait, since we are in node, we can connect to MongoDB and query the OTP!
    // That is incredibly smart and robust.
